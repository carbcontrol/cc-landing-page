        ...
        <div className="md:flex items-center">
          <div className="md:w-[478px]">
            ...
            <h1 className="md:text-7xl text-5xl font-bold tracking-tighter bg-gradient-to-b from-[#e43e00] to-[#FF4500] text-transparent bg-clip-text mt-6" >
              <div className="">Carb</div>
              <div className="">Control</div>
            </h1>
            <p className="text-xl text-[#FF4500] tracking-tight mt-6">Get personalized diet plans and easily track calories by scanning your meals, helping you stay on track with your health goals.</p>
